		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-body">
						<p></p>
						<h5 class="card-title">Agregar alumnos al nuevo Curso</h5>
						
						<hr>
						
						<p><strong>Materia: </strong>Administración</p>
						<p><strong>Período: </strong>Primer Semestre</p>
						<p><strong>Año: </strong>2021</p>
						<p><strong>Profesor/a: </strong>Cardozo, Teresa</p>
