...
public class AdmProfesorServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("btnregistrar") != null) {
			...
			if (request.getParameter("name") != null && request.getParameter("apellido") != null
					&& request.getParameter("dni") != null && request.getParameter("nacimiento") != null
					&& request.getParameter("provincias") != null && request.getParameter("estado") != null
					&& request.getParameter("direccion") != null && request.getParameter("mail") != null
				...
				try {
					...
					// SE VALIDA QUE EL DNI NO HAYA SUDO UTILIZADO NI EN ALGUN ALUMNO NI EN
					// PROFESORES
					if (NegocioA.verificar(persona.getDni()) == true || NegocioP.verificar(persona.getDni()) == true) {
						...
						MensajeRegistrar = "-2";
					} else if (NegocioP.existeEmail(request.getParameter("mail")) == true
		...
		if (request.getParameter("EditarEstado") != null) {
			...
			NegocioProfesor NegocioProfesor = new NegocioProfesorImpl();
			int EstadoEditado = 0;
			if (request.getParameter("LegajoProfesor") != null && request.getParameter("EstadoProfesor") != null) {
				try {
					EstadoEditado = NegocioProfesor.BajaProfesor(new Profesor(Integer.parseInt(request.getParameter("LegajoProfesor")), new Estado(Integer.parseInt(request.getParameter("EstadoProfesor")))));
				} catch (Exception e) {
					// TODO: handle exception
				}
			}
		...
		if (request.getParameter("btnEditarProfesor") != null) {
			...
			//
			if (request.getParameter("txtLegajo") != null && request.getParameter("txtNombre") != null
					&& request.getParameter("txtApellido") != null && request.getParameter("txtDni") != null
					&& request.getParameter("txtDireccion") != null && request.getParameter("txtTelefono") != null
					&& request.getParameter("txtProvincia") != null && request.getParameter("txtUsuario") != null
					&& request.getParameter("txtEmail") != null && request.getParameter("txtNacimiento") != null) {
				try {
